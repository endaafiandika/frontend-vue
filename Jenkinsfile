                    ...
                    sshPublisher(
                        publishers: [
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        execCommand: 'docker pull endaafiandika/frontend-vue:production; docker kill frontend-vue:master;docker run -d --rm -p 8080:80 --name frontend endaafiandika/frontend-vue:production',
                                        execTimeout: 120000,
                                    )
                                ]
                            )
